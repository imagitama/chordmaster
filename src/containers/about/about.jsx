...
export default () => (
  <ContentArea>
    ...
    <p>
      ...
      <A href={settings.githubRepoUrl}>open source project</A>. If you can code,
      he appreciates your contribution. Otherwise you can send feedback using
      the feedback button at the top right of the page.
    </p>
